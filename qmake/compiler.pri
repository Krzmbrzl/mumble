...
win32-msvc* {
	...
	QMAKE_LFLAGS_WINDOWS -= /OPT:ICF
	QMAKE_LFLAGS_WINDOWS -= /OPT:REF
	QMAKE_LFLAGS_WINDOWS *= /DEBUG /OPT:NOICF /OPT:NOREF
	QMAKE_LFLAGS_CONSOLE -= /OPT:ICF
	QMAKE_LFLAGS_CONSOLE -= /OPT:REF
	QMAKE_LFLAGS_CONSOLE *= /DEBUG /OPT:NOICF /OPT:NOREF
	DEFINES *= RESTRICT=
	CONFIG(sse2) {
	      QMAKE_CFLAGS_RELEASE -= -arch:SSE
	...
	CONFIG(symbols) {
		...
		QMAKE_LIBFLAGS *= /DEBUG /OPT:REF /OPT:NOICF /INCREMENTAL:NO
