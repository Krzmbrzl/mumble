...
#undef PROCESS_MUMBLE_UDP_MESSAGE
	...
	namespace AudioContext {
		constexpr audio_context_t Invalid = 0xFF; // This is the equivalent of -1 as a 8bit number
	...
	public:
		...
		bool decode(const gsl::span< const byte > data);
 ...
 * never want to happen). See https://stackoverflow.com/a/50385277/3907364
 */
