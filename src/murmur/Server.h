...
public:
	...
	Mumble::Protocol::UDPPingEncoder< Mumble::Protocol::Role::Server > m_pingEncoder;
	Mumble::Protocol::UDPAudioEncoder< Mumble::Protocol::Role::Server > m_audioEncoder;
...
private:
	...
	AudioReceiverBuffer m_audioReceivers;
