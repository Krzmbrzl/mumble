...
void ::Murmur::ServerI::getListenerVolumeAdjustment_async(const ::Murmur::AMD_Server_getListenerVolumeAdjustmentPtr &cb,  ::Ice::Int p1,  ::Ice::Int p2, const ::Ice::Current &current) {
...
void ::Murmur::ServerI::setListenerVolumeAdjustment_async(const ::Murmur::AMD_Server_setListenerVolumeAdjustmentPtr &cb,  ::Ice::Int p1,  ::Ice::Int p2,  ::Ice::Float p3, const ::Ice::Current &current) {
